    ...
    function drawTemplate(container) {
        ...
        container
            ...
            <div class="pt-2 js-collapse" style="display: none">
                <div class="card mb-0">
                    <div class="text-center font-weight-bold py-2 js-dayname card-header"></div>
        ...
        function events() {
            container
                ...
                .on('click', '[data-date]', function (e) {
                    ...
                    container.find('.js-dayname').html(formatDateReadable(date));
        ...
        function drawEventList(container, events, date) {
            ...
            events.forEach(event => {
                ...
                let eventWrapper = $('<div>', {
                    class: 'js-event d-flex justify-content-between align-items-center list-group-item',
                    html: `
